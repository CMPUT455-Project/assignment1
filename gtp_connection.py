...
class GtpConnection:
    ...
    def play_cmd(self, args):
        ...
        try:
            ...
            if args[0].lower() != 'b' and args[0].lower() != 'w':
                self.respond('illegal move: "{}" wrong color'.format(str(args[0]).lower()))
                return
            ...
            if not self.board.play_move(move, color):
                self.respond('illegal move: "{}" occupied'.format(str(board_move).lower()))
                return
            else:
                self.debug_msg(
